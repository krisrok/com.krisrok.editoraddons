...
public class SetFromPatternAttributeDrawer : OdinAttributeDrawer<SetFromPatternAttribute>, IDefinesGenericMenuItems
{
    ...
    {
        Property.ValueEntry.WeakSmartValue = SetFromPatternTools.TransformPattern(Property.ValueEntry.WeakSmartValue as string, (Property.SerializationRoot.ValueEntry.WeakSmartValue as Component).gameObject);
    }
}
